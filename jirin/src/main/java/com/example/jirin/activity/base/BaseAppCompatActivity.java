 ...
 * @Author pengfan
 * @Date 2023/4/8
 * @Description 添加防连点事件和Handler处理机制的AppCompatActivity
 */
public abstract class BaseAppCompatActivity extends AppCompatActivity {
    ...
    private static class BaseHandler extends Handler {
        ...
        public BaseHandler(AppCompatActivity activity) {
            ...
            if (activityWeakReference != null) {
                ...
                if (activity != null) {
                    if (activity instanceof BaseAppCompatActivity) {
                        ((BaseAppCompatActivity) activity).handleMessage(activity, msg);
                    } else {
                        LogUtil.e(TAG, "handleMessage: activity isn't " +
                                "BaseAppCompatActivity instance");
                    }
                } else {
